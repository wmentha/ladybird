...
static ErrorOr<pid_t> launch_browser(String const& socket_path)
{
...
static ErrorOr<pid_t> launch_headless_browser(String const& socket_path)
{
...
{
    String default_listen_address = "0.0.0.0"_string;
