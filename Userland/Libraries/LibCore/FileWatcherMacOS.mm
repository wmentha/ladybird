...
public:
    ...
    static ErrorOr<NonnullRefPtr<FileWatcherMacOS>> create(FileWatcherFlags)
    {
        ...
        auto queue_name = String::formatted("Serenity.FileWatcher.{:p}", context.ptr());
    ...
    ErrorOr<MonitoredPath> canonicalize_path(String path)
    {
...
private:
    ...
    HashMap<String, ino_t> m_path_to_inode_id;
...
void on_file_system_event(ConstFSEventStreamRef, void* user_data, size_t event_size, void* event_paths, FSEventStreamEventFlags const event_flags[], FSEventStreamEventId const[])
{
    ...
    for (size_t i = 0; i < event_size; ++i) {
        ...
        auto maybe_monitored_path = file_watcher.canonicalize_path(String { file_path_buffer });
