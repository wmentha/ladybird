...
private:
    ...
    virtual void did_change_title(u64 page_id, String const&) override;
    virtual void did_change_url(u64 page_id, URL::URL const&) override;
    virtual void did_request_tooltip_override(u64 page_id, Gfx::IntPoint, String const&) override;
    virtual void did_stop_tooltip_override(u64 page_id) override;
    virtual void did_enter_tooltip_area(u64 page_id, String const&) override;
    ...
    virtual void did_click_link(u64 page_id, URL::URL const&, String const&, unsigned) override;
    virtual void did_middle_click_link(u64 page_id, URL::URL const&, String const&, unsigned) override;
    ...
    virtual void did_request_link_context_menu(u64 page_id, Gfx::IntPoint, URL::URL const&, String const&, unsigned) override;
    virtual void did_request_image_context_menu(u64 page_id, Gfx::IntPoint, URL::URL const&, String const&, unsigned, Gfx::ShareableBitmap const&) override;
    virtual void did_request_media_context_menu(u64 page_id, Gfx::IntPoint, String const&, unsigned, Web::Page::MediaContextMenu const&) override;
    ...
    virtual void did_request_file(u64 page_id, String const& path, i32) override;
