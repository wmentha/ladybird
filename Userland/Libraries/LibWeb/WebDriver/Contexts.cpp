...
static String const WEB_WINDOW_IDENTIFIER = "window-fcc6-11e5-b4f8-330a88ab9d7f"_string;

// https://w3c.github.io/webdriver/#dfn-web-frame-identifier
static String const WEB_FRAME_IDENTIFIER = "frame-075b-4da1-b6ba-e579c2d3230a"_string;
...
JsonObject window_proxy_reference_object(HTML::WindowProxy const& window)
{
    ...
    object.set(identifier, navigable->traversable_navigable()->window_handle().to_string());
