...
public:
    ...
    static JS::NonnullGCPtr<ClassicScript> create(String filename, StringView source, JS::Realm&, URL::URL base_url, size_t source_line_number = 1, MutedErrors = MutedErrors::No);
...
private:
    ClassicScript(URL::URL base_url, String filename, JS::Realm&);
