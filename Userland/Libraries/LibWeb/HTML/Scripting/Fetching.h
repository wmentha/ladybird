...
WebIDL::ExceptionOr<Optional<URL::URL>> resolve_imports_match(String const& normalized_specifier, Optional<URL::URL> as_url, ModuleSpecifierMap const&);
...
void fetch_inline_module_script_graph(JS::Realm&, String const& filename, String const& source_text, URL::URL const& base_url, EnvironmentSettingsObject& settings_object, OnFetchScriptComplete on_complete);
...
Fetch::Infrastructure::Request::Destination fetch_destination_from_module_type(Fetch::Infrastructure::Request::Destination, String const&);
