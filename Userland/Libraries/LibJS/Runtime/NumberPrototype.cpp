...
JS_DEFINE_NATIVE_FUNCTION(NumberPrototype::to_exponential)
{
    ...
    // 13. Else,
        ...
        exponent_string = MUST(String::number(exponent));
    }
...
JS_DEFINE_NATIVE_FUNCTION(NumberPrototype::to_fixed)
{
    ...
    auto number_format_string = MUST(String::formatted("{{}}{{:.{}f}}", fraction_digits));
    return PrimitiveString::create(vm, MUST(String::formatted(number_format_string, s, number)));
}
...
JS_DEFINE_NATIVE_FUNCTION(NumberPrototype::to_precision)
{
    ...
    // 10. Else,
        ...
        if ((exponent < -6) || (exponent >= precision)) {
            ...
            auto exponent_string = MUST(String::number(exponent));
