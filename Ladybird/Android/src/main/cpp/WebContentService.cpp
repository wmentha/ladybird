...
static ErrorOr<void> load_content_filters()
{
    auto file_or_error = Core::File::open(MUST(String::formatted("{}/res/ladybird/default-config/BrowserContentFilters.txt", s_ladybird_resource_root)), Core::File::OpenMode::Read);
